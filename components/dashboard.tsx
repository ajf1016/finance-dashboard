    ...
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6">
          <div className="mb-8">
            <h1 className="text-2xl font-bold">Good morning, Yashna!</h1>
          ...
          <div className="mt-10">
            <TabNavigation
              activeTab={activeTab}
              onTabChange={(tab) => setActiveTab(tab as "performance" | "portfolio")}
            />

            {activeTab === "performance" ? <PerformanceMetrics /> : <PortfolioComposition />}
          </div>
        </main>
      </div>
    </div>
